...
enum InvocationName: String, CaseIterable {
    ...
    var approvalLabel: String {
        ...
        case .serviceFind: L10n.string("Search plugins")
        case .serviceListAttached: L10n.string("List attached plugins")
        case .serviceInspect: L10n.string("Inspect a plugin")
        case .serviceCreate: L10n.string("Create a plugin")
        case .serviceCopy: L10n.string("Copy a plugin to Local")
        case .serviceDelete: L10n.string("Delete a Local plugin")
        case .serviceGitStatus: L10n.string("Check plugin changes")
        case .serviceGitLog: L10n.string("Read plugin history")
        case .serviceGitShow: L10n.string("Read a plugin commit")
        case .serviceGitDiff: L10n.string("Check plugin changes")
        case .serviceGitCheckout: L10n.string("Visit a plugin commit")
        case .serviceGitCommit: L10n.string("Commit Local plugins")
        case .serviceGitRevert: L10n.string("Revert a Local commit")
        case .serviceGitRestore: L10n.string("Discard Local changes")
        case .serviceAttach: L10n.string("Attach a plugin")
        case .serviceSignIn: L10n.string("Plugin sign-in")
        case .serviceSolve: L10n.string("Plugin verification")
        case .servicePayment: L10n.string("Plugin checkout")
        case .serviceDetach: L10n.string("Detach a plugin")
