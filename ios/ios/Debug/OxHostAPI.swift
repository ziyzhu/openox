...
enum OxHostAPI {
    ...
    static func handle(
        ...
        case .getTranscript(let request): DebugUIAPI.handleGetTranscript(request, reply: reply)
        ...
        case .openTranscriptFixture(let request): handleOpenTranscriptFixture(request, chatManager: chats, reply: reply)
        case .retainBaselineSessions(let request): handleRetainBaselineSessions(request, chatManager: chats, reply: reply)
        ...
        case .vmListSessions(let request): handleVMListSessions(request, chatManager: chats, reply: reply)
