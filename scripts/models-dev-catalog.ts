...
const catalogPath = join(ROOT, "ios/ios/LLMConfiguration/models-dev-catalog.json");
const selectionPath = join(ROOT, "ios/ios/LLMConfiguration/models-dev-selection.json");
