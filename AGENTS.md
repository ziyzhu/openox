...
1. Use Capability/Capabilities for Ox functionality in iOS UI copy; keep Action/actions in data models and protocols. Preserve Apple's Shortcuts action terminology.
