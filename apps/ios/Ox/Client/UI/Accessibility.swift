...
nonisolated enum A11yID {
    ...
    enum Settings {
        ...
        static let artifacts = "settings.artifacts"
        static let skills = "settings.skills"
    ...
    enum Chat {
        ...
        static let speechEdit = "chat.speechEdit"
        ...
        static let modelAPIProviders = "chat.modelAPIProviders"
